 # Assignment #6: Classes and resources, IO operators
...
In this assignment, you will implement copy constructor and copy assignment to prevent memory leak and resize allocated memory.
...
# Part 1 - Development (DEV) (100%) The Numbers module.
...
[View the Slides](dev/memoryResizing.pdf)
...
Next, run the **submission command** from within your assignment repository folder on your Matrix account to test the execution of your DIY section.
