# Assignment #3: Member Functions and Privacy 
V(0.9) being reviewed

In this assignment, you will implement member functions, constructors, destructor and apply privacy and a safe empty state for a class.
...
- describe to your instructor what you have learned in completing this assignment

# Part 1 - Development (DEV) (100%)

Your task for part one of assignment 3 is to create a class called "CC" that encapsulates a Credit Card (in CC.h and CC.cpp) and displays the credit card information.
...
Next, run the **submission command** from within your assignment repository folder on your Matrix account to test the execution of your DIY Part.
